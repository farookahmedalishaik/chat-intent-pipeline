...
"""
Uploads the data artifacts generated by prepare_data.py to a dataset repository on the Hugging Face Hub.
"""
import os
...
def main():
    ...
    # List of files that needs to upload from the local artifacts directory &  includes files generated by prepare_data.py
    files_to_upload = [
        LABEL_MAPPING_FILE,
        CLASS_WEIGHTS_FILE,
        TRAIN_DATA_FILE,
